                ...
                <div class="card-body">
                    <form action="{{route('store_actuator')}}" method="POST">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="name" placeholder="Actuator Name" aria-label="Actuator name" aria-describedby="button-addon2">
